"use strict";;let sql;_34f‍.x([["getUserData",()=>getUserData],["updateDbUser",()=>updateDbUser],["deleteDbUser",()=>deleteDbUser]]);_34f‍.w("mssql",[["default",["sql"],function(v){sql=v}]]);
...
var config = {
    ...
    try {
        ...
        _34f‍.g.console.log('requete_getData, erreur : ' + error);
    }
    ...
    try {
        ...
        _34f‍.g.console.log('Requete-register, erreur : ' + error);
    }
}
    ...
    try {
        ...
        await pool.request()
            .input('id', id)
            .query('DELETE utilisateur WHERE id = @id');
    } catch (error) {
        _34f‍.g.console.log('Delete user db : ' + error);
    }
}