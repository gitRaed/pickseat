"use strict";;let recupererData,nodemailer,express,bodyParser;_ec4‍.x([["register",()=>route]]);_ec4‍.w("../../serviceLayer/code_register.mjs",[["recupererData",["recupererData"],function(v){recupererData=v}]]);_ec4‍.w("nodemailer",[["*",null,function(v){nodemailer=v}]]);_ec4‍.w("express",[["default",["express"],function(v){express=v}]]);_ec4‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);
...
route.post("/", async (req, res, next) => {
    ...
    smtpTransport.sendMail(mailOptions, function (error, response) {
        ...
        if (error) {
            _ec4‍.g.console.log('Erreur sendMail : ' + error + ' \n');
            res.end("error");
        } else {
            res.end("sent");
        }
