"use strict";;let registerData,registerFinalCode,resetPasswordcode,nodemailer,express,bodyParser;_e6d‍.x([["register",()=>route]]);_e6d‍.w("../../serviceLayer/code_register.mjs",[["registerData",["registerData"],function(v){registerData=v}],["registerFinalCode",["registerFinalCode"],function(v){registerFinalCode=v}],["resetPasswordcode",["resetPasswordcode"],function(v){resetPasswordcode=v}]]);_e6d‍.w("nodemailer",[["*",null,function(v){nodemailer=v}]]);_e6d‍.w("express",[["default",["express"],function(v){express=v}]]);_e6d‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);
...
route.post("/", async (req, res, next) => {
    ...
    smtpTransport.sendMail(mailOptions, function (error, response) {
        ...
        if (error) {
            _e6d‍.g.console.log('Erreur sendMail : ' + error + ' \n');
            res.end("error");
        } else {
            res.end("sent");
        }
...
route.post('/forgotPassword', async (req, res, next) => {
    ...
    smtpTransport.sendMail(mailOptions, function (error, response) {
        ...
        if (error) {
            _e6d‍.g.console.log('Erreur sendMail forgot password: ' + error + ' \n');
            res.end("error");
        } else {
            res.end("sent");
        }
