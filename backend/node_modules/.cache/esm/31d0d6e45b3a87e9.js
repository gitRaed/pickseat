"use strict";;let sql;_5b3‍.x([["registerMessage",()=>registerMessage],["getPointImportant",()=>getPointImportant],["registerPointImportant",()=>registerPointImportant],["updatePointImportant",()=>updatePointImportant],["deletePointImportant",()=>deletePointImportant],["alarme",()=>alarme],["getTrajet",()=>getTrajet],["rechercherTrajet1",()=>rechercherTrajet1],["rechercherEscale",()=>rechercherEscale],["enregistrerTrajet",()=>enregistrerTrajet],["updateTrajet",()=>updateTrajet],["getTrajetDate",()=>getTrajetDate],["deleteTrajetDate",()=>deleteTrajetDate],["registerDemande",()=>registerDemande],["getDemandeChauffeur",()=>getDemandeChauffeur],["getDemandeVoyageur",()=>getDemandeVoyageur],["getDemande",()=>getDemande],["updateDemandeStatus",()=>updateDemandeStatus],["getDemandeDate",()=>getDemandeDate],["deleteDemande",()=>deleteDemande],["notificationChauffeur",()=>notificationChauffeur],["notificationVoyageur",()=>notificationVoyageur]]);_5b3‍.w("mssql",[["default",["sql"],function(v){sql=v}]]);
...
// * enregitre le message de contactUs du front
    ...
    try {
        ...
        _5b3‍.g.console.log('Register Message, erreur : ' + error);
...
//#region point important 
    ...
    try {
        ...
        _5b3‍.g.console.log('Requete_map, get point important error : ' + error);
        return error;
    }
}

       async function registerPointImportant(email, message, latitude, longitude, sonner) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Register point important error : ' + error);
        return 'Register point important error : ' + error;
    }
}

       async function updatePointImportant(id, message, sonner) {
    ...
    try {
        ...
        _5b3‍.g.console.log("update point important error : " + error);
        return error;
    }
}
    ...
    try {
        ...
        _5b3‍.g.console.log('Delete point important error : ' + error);
        return error;
    }
}

       async function alarme(email) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête alarme error : ' + error);
        return error;
    }
}
...
//#region trajet
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête getTrajet error : ' + error);
        return error;
    }
}

       async function rechercherTrajet1(adresse_depart, adresse_arrive) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Rerchercher trajet error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête rechercher escale error : ' + error);
        return error;
    }
}

       async function enregistrerTrajet(nom_chauffeur, prenom_chauffeur, email, numero, adresse_depart, adresse_arrive, heure_trajet, date_trajet, options, escale, tarif_total, tarif_escale) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête enregistrer trajet error : ' + error);
        return error;
    }
}

       async function updateTrajet(id, adresse_depart, adresse_arrive, heure_trajet, date_trajet, options, escale, tarif_total, tarif_escale) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête update trajet error : ' + error);
        return error;
    }
}


       async function getTrajetDate(email) {
    ...
    try {
       ...
       async function deleteTrajetDate(date) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Delete trajet date error ' + error);
        return error;
    }
}
...
//#region demandes 
       async function registerDemande(nom_chauffeur, prenom_chauffeur, numero_chauffeur, email_chauffeur,
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête register demande error : ' + error);

    }
}

       async function getDemandeChauffeur(email_chauffeur) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête get demande chauffeur error : ' + error);
    }
}

       async function getDemandeVoyageur(email_voyageur) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête get demande voyageur error : ' + error);
    }
}
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête get demande error ' + error);
    }
}
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête updateDemandeStatus error : ' + error);
    }
}

       async function getDemandeDate() {
    ...
    try {
       ...
       async function deleteDemande(date) {
...
//#region notification
       ...
       async function notificationChauffeur(email) {
    ...
    try {
        ...
        _5b3‍.g.console.log('Requête notification chauffeur error : ' + error);
    }
}

       async function notificationVoyageur(email) {
