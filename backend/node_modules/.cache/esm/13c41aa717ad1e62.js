"use strict";;let registerData,registerFinalCode,resetPasswordcode,nodemailer,express,bodyParser;_17a‍.x([["register",()=>route]]);_17a‍.w("../../serviceLayer/code_register.mjs",[["registerData",["registerData"],function(v){registerData=v}],["registerFinalCode",["registerFinalCode"],function(v){registerFinalCode=v}],["resetPasswordcode",["resetPasswordcode"],function(v){resetPasswordcode=v}]]);_17a‍.w("nodemailer",[["*",null,function(v){nodemailer=v}]]);_17a‍.w("express",[["default",["express"],function(v){express=v}]]);_17a‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);
...
route.post("/", async (req, res, next) => {
    ...
    smtpTransport.sendMail(mailOptions, function (error, response) {
        ...
        if (error) {
            _17a‍.g.console.log('Erreur sendMail : ' + error + ' \n');
            res.end("error");
        } else {
            res.end("sent");
        }
...
route.post('/forgotPassword', async (req, res, next) => {
    ...
    smtpTransport.sendMail(mailOptions, function (error, response) {
        ...
        if (error) {
            _17a‍.g.console.log('Erreur sendMail forgot password: ' + error + ' \n');
            res.end("error");
        } else {
            res.end("sent");
        }
