...
route.post("/contactUs", async (req, res) => {
    ...
    try {
        ...
        _636‍.g.console.log('Contact us error : ' + error);
        res.send({
            message: error
        });
        res.status(500);
...
route.post("/getPointImportant", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Get points important error : ' + error);
        res.send({
...
route.post("/pointImportant", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Point important error : ' + error);
        res.send({
            message: error
        });
    }
...
route.post("/updatePoint", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Update point important error : ' + error);
        res.send({
            message: error
        });
    }
...
route.post("/deletePoint", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Delete point important error : ' + error);
        res.send({
            message: error
        });
    }
...
route.post("/alarme", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Alarme error : ' + error);
        res.send({
            message: error
        });
    }
...
route.post("/getTrajet", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Get trajet error : ' + error);
        res.send({
            message: error
        });
    }
...
route.post("/rechercherTrajet", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Rechercher trajet error : ' + error);
        res.send({
            message : error
        });
    }
...
route.post("/enregistrerTrajet", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Enregistrer trajet error : ' + error);
        res.send({
            message : error
        });
    }
...
route.post("/updateTrajet", async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Update trajet error : ' + error);
        res.send({
            message: error
        });
    }
...
route.post('/registerDemande', async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Register demande error : ' + error);
        return error;
    }
});
...
route.post('/getDemandeUser', async (req, res) => {
    ...
    try {
        ...
        res.status(500);
        _636‍.g.console.log('Get demande error : ' + error);
        return error;
    }
});
...
route.post('/notifications', async (req, res) => {
    ...
    try {
        ...
        _636‍.g.console.log('Notification error : ' + error);
    }
});
//#endregion
