"use strict";;let recupererData,nodemailer,express,bodyParser;_da7‍.x([["register",()=>route]]);_da7‍.w("../../serviceLayer/code_register.mjs",[["recupererData",["recupererData"],function(v){recupererData=v}]]);_da7‍.w("nodemailer",[["*",null,function(v){nodemailer=v}]]);_da7‍.w("express",[["default",["express"],function(v){express=v}]]);_da7‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);
...
route.post("/", async (req, res, next) => {
    ...
    smtpTransport.sendMail(mailOptions, function (error, response) {
        ...
        if (error) {
            _da7‍.g.console.log('Erreur sendMail : ' + error + ' \n');
            res.end("error");
        } else {
            res.end("sent");
        }
