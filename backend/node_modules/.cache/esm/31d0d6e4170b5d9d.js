...
// * enregitre le message de contactUs du front
    ...
    try {
        ...
        _170‍.g.console.log('Register Message, erreur : ' + error);
...
//#region point important 
    ...
    try {
        ...
        _170‍.g.console.log('Requete_map, get point important error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Register point important error : ' + error);
    ...
    try {
        ...
        _170‍.g.console.log("update point important error : " + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Delete point important error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête alarme error : ' + error);
        return error;
    }
}
...
//#region trajet
    ...
    try {
        ...
        _170‍.g.console.log('Requête getTrajet error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Rerchercher trajet error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête rechercher escale error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête enregistrer trajet error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête update trajet error : ' + error);
        return error;
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Delete trajet date error ' + error);
        return error;
    }
}
...
//#region demandes 
    ...
    try {
        ...
        _170‍.g.console.log('Requête register demande error : ' + error);
    ...
    try {
        ...
        _170‍.g.console.log('Requête get demande chauffeur error : ' + error);
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête get demande voyageur error : ' + error);
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête get demande error ' + error);
    }
}
    ...
    try {
        ...
        _170‍.g.console.log('Requête updateDemandeStatus error : ' + error);
    }
}
...
//#region notification
    ...
    try {
        ...
        _170‍.g.console.log('Requête notification chauffeur error : ' + error);
    }
}
